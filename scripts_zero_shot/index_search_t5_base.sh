...
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/search_zero_shot_flan_t5_base.out
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/search_zero_shot_flan_t5_base.out
#SBATCH --array=1
