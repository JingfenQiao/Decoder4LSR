...
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/search_zero_shot_opt_350m.out
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_evallog/search_zero_shot_opt_350m.out
#SBATCH --array=1
#SBATCH --partition=cpu

export HYDRA_FULL_ERROR=1
MODLE_NAME=zero_shot_opt_350m
