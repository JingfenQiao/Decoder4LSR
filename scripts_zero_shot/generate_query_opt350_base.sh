...
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/zero_shot_opt_350m%a.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/zero_shot_opt_350m%a.output
#SBATCH --array=1-5   # We have 5 files
#SBATCH --gres=gpu:1   # Request one GPU per task

export variable HYDRA_FULL_ERROR=1
# experiment=zero_shot_opt_350m
