...
#SBATCH --output=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/search_zero_shot_opt_6.7b%a.out
#SBATCH --error=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/search_zero_shot_opt_6.7b%a.out
#SBATCH --array=1
#SBATCH --partition=cpu

export HYDRA_FULL_ERROR=1
MODLE_NAME=zero_shot_opt_6.7b
