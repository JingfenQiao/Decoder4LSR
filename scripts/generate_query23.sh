...
#SBATCH --output=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/rankllama_mlm_encoder_decoder_multi_t5_base_0.01.output
#SBATCH --error=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/rankllama_mlm_encoder_decoder_multi_t5_base_0.01.output
