#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=mlm_encoder_decoder_multi_t5_base_0.01_multi
#SBATCH --mem=30G
#SBATCH --time=50:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/mlm_encoder_decoder_multi_t5_base_0.01_multi%a.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/mlm_encoder_decoder_multi_t5_base_0.01_multi%a.output
...
+experiment=mlm_encoder_decoder_multi_t5_base_0.01_multi