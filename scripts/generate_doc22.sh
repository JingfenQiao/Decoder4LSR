#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=rankllama_splade_msmarco_distil_flops_0.1_0.08_affine_querywise
#SBATCH --mem=30G
#SBATCH --time=50:00:00
#SBATCH --output=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/rankllama_splade_msmarco_distil_flops_0.1_0.08_affine_querywise%a.output
#SBATCH --error=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/rankllama_splade_msmarco_distil_flops_0.1_0.08_affine_querywise%a.output
...
+experiment=rankllama_splade_msmarco_distil_flops_0.1_0.08_querywise