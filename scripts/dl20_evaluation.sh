#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=splade_affine_dl20_querywise
#SBATCH --mem=30G
#SBATCH --time=10:00:00
#SBATCH --output=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/splade_affine_querywise_dl20.output
#SBATCH --error=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/splade_affine_querywise_dl20.output
...
input_path=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/data/msmarco/TREC_DL_2020/queries_2020/raw.tsv
