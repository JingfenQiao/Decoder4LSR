#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=search_dl19_20_rankllama_mlm_decoder_only_opt3.5_0.009
#SBATCH --mem=30G
#SBATCH --time=10:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/search_dl19_20_rankllama_mlm_decoder_only_opt3.5_0.009.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/search_dl19_20_rankllama_mlm_decoder_only_opt3.5_0.009.output
#SBATCH --gres=gpu   # Request one GPU per task

export variable HYDRA_FULL_ERROR=1
MODLE_NAME=rankllama_mlm_decoder_only_opt3.5_0.009
