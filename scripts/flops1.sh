#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=flops_qmlm_dmlp_encoder_decoder_multi_t5_base_0
#SBATCH --mem=30G
#SBATCH --time=5:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/flops_qmlm_dmlp_encoder_decoder_multi_t5_base_0.1_0.0%a.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/flops_qmlm_dmlp_encoder_decoder_multi_t5_base_0.1_0.0%a.output
...
INPUT_DIR=/ivi/ilps/personal/jqiao/lsr_eval/outputs/qmlm_dmlp_encoder_decoder_multi_t5_base_0.1_0.0/inference
