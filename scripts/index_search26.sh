#!/bin/bash
#SBATCH --job-name=search_rankllama_mlm_encoder_decoder_multi_t5_base_0.01_affine_nonprompt
#SBATCH --mem=30G
#SBATCH --time=50:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/search_rankllama_mlm_encoder_decoder_multi_t5_base_0.01_affine_nonprompt%a.out
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/search_rankllama_mlm_encoder_decoder_multi_t5_base_0.01_affine_nonprompt%a.out
#SBATCH --array=1
