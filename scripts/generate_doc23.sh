#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=rankllama_mlm_encoder_decoder_multi_t5_base_0.01
#SBATCH --mem=30G
#SBATCH --time=50:00:00
#SBATCH --output=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/rankllama_mlm_encoder_decoder_multi_t5_base_0.01%a.output
#SBATCH --error=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/rankllama_mlm_encoder_decoder_multi_t5_base_0.01%a.output
...
+experiment=rankllama_mlm_encoder_decoder_multi_t5_base_0.01