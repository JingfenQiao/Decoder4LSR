#!/bin/bash
#SBATCH --job-name=search_mlm_decoder_only_opt3.5_0.1
#SBATCH --mem=30G
#SBATCH --time=50:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/search_mlm_decoder_only_opt3.5_0.1%a.out
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/search_mlm_decoder_only_opt3.5_0.1%a.out
#SBATCH --array=1
#SBATCH --partition=cpu


export HYDRA_FULL_ERROR=1
MODLE_NAME=mlm_decoder_only_opt3.5_0.1
