#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=mlm_decoder_only_opt13_0.001
#SBATCH --mem=30G
#SBATCH --time=50:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/mlm_decoder_only_opt13_0.001%a.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/mlm_decoder_only_opt13_0.001%a.output
...
+experiment=mlm_decoder_only_opt13_0.001