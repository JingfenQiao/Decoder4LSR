#!/bin/bash
#SBATCH --job-name=search_decoder_only_opt13_0.01
#SBATCH --mem=30G
#SBATCH --time=50:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/search_decoder_only_opt13_0.01%a.out
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/search_decoder_only_opt13_0.01%a.out
#SBATCH --array=1
