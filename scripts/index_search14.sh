...
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/search_rankllama_mlm_encoder_decoder_multi_t5_base_0.01%a.out
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/search_rankllama_mlm_encoder_decoder_multi_t5_base_0.01%a.out
#SBATCH --array=1
