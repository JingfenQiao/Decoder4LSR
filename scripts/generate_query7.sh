...
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/mlp_decoder_only_opt3.5.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/mlp_decoder_only_opt3.5.output
