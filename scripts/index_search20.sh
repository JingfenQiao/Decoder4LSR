#!/bin/bash
#SBATCH --job-name=search_rankllama_splade_msmarco_distil_flops_0.1_0.08
#SBATCH --mem=30G
#SBATCH --time=50:00:00
#SBATCH --output=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/search_rankllama_splade_msmarco_distil_flops_0.1_0.08%a.out
#SBATCH --error=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/search_rankllama_splade_msmarco_distil_flops_0.1_0.08%a.out
#SBATCH --array=1
#SBATCH --partition=cpu

export HYDRA_FULL_ERROR=1
MODLE_NAME=rankllama_splade_msmarco_distil_flops_0.1_0.08
