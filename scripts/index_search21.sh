#!/bin/bash
#SBATCH --job-name=search_splade_affine
#SBATCH --mem=30G
#SBATCH --time=50:00:00
#SBATCH --output=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/search_splade_affine%a.out
#SBATCH --error=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/search_splade_affine%a.out
#SBATCH --array=1
