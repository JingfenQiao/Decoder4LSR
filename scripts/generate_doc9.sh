#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=mlm_encoder_only_t5_base_0.1_0.08
#SBATCH --mem=30G
#SBATCH --time=15:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/mlm_encoder_only_t5_base_0.1_0.08%a.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/mlm_encoder_only_t5_base_0.1_0.08%a.output
...
+experiment=mlm_encoder_only_t5_base_0.1_0.08