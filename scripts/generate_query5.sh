...
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/qmlm_dmlp_encoder_decoder_multi_t5_base_0.1_0.0.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/qmlm_dmlp_encoder_decoder_multi_t5_base_0.1_0.0.output
