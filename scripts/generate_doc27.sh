#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=rankllama_mlm_decoder_only_opt3.5_0.009_nopromopt
#SBATCH --mem=30G
#SBATCH --time=50:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/rankllama_mlm_decoder_only_opt3.5_0.009_nopromopt%a.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/rankllama_mlm_decoder_only_opt3.5_0.009_nopromopt%a.output
...
+experiment=rankllama_mlm_decoder_only_opt3.5_0.05_nonprompt
