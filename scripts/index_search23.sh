#!/bin/bash
#SBATCH --job-name=search_rankllama_mlm_encoder_decoder_multi_t5_base_0.01
#SBATCH --mem=30G
#SBATCH --time=50:00:00
#SBATCH --output=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/search_rankllama_mlm_encoder_decoder_multi_t5_base_0.01%a.out
#SBATCH --error=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/search_rankllama_mlm_encoder_decoder_multi_t5_base_0.01%a.out
#SBATCH --array=1
#SBATCH --partition=cpu

export HYDRA_FULL_ERROR=1
MODLE_NAME=rankllama_mlm_encoder_decoder_multi_t5_base_0.01
