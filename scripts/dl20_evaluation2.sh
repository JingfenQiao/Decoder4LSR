#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=splade_dl20
#SBATCH --mem=30G
#SBATCH --time=10:00:00
#SBATCH --output=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/splade_dl20.output
#SBATCH --error=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/splade_dl20.output
