...
#SBATCH --output=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/rankllama_splade_msmarco_distil_flops_0.1_0.08_affine_querywise.output
#SBATCH --error=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/rankllama_splade_msmarco_distil_flops_0.1_0.08_affine_querywise.output
