...
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/mlp_encoder_decoder_single_t5_base%a.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/mlp_encoder_decoder_single_t5_base%a.output
