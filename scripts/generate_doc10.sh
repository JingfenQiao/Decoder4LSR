#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=mlm_decoder_only_opt3.5_0.1
#SBATCH --mem=30G
#SBATCH --time=25:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/mlm_decoder_only_opt3.5_0.1%a.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/mlm_decoder_only_opt3.5_0.1%a.output
...
+experiment=mlm_decoder_only_opt3.5_0.1