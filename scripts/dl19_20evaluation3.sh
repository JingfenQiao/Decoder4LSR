#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=search_dl19_20_rankllama_mlm_encoder_decoder_multi_t5_base_0.01_affine.output
#SBATCH --mem=30G
#SBATCH --time=10:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/search_dl19_20_rankllama_mlm_encoder_decoder_multi_t5_base_0.01_affine2.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/search_dl19_20_rankllama_mlm_encoder_decoder_multi_t5_base_0.01_affine2.output
...
+experiment=rankllama_mlm_encoder_decoder_multi_t5_base_0.01_affine
