...
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/mlp_encoder_decoder_multi_t5_base.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/mlp_encoder_decoder_multi_t5_base.output
