...
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/rankllama_mlm_decoder_only_opt3.5_0.009_nopromopt.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/rankllama_mlm_decoder_only_opt3.5_0.009_nopromopt.output
