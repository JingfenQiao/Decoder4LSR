#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=flops_rankllama_mlm_decoder_only_opt3.5_0.009
#SBATCH --mem=30G
#SBATCH --time=5:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/flops_rankllama_mlm_decoder_only_opt3.5_0.009%a.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/flops_rankllama_mlm_decoder_only_opt3.5_0.009%a.output
...
INPUT_DIR=/ivi/ilps/personal/jqiao/lsr_eval/outputs/rankllama_mlm_decoder_only_opt3.5_0.009/inference
