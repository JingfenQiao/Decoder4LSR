#!/bin/bash
#SBATCH --job-name=search_rankllama_mlm_decoder_only_opt3.5_0.009_nopromopt
#SBATCH --mem=30G
#SBATCH --time=50:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/search_rankllama_mlm_decoder_only_opt3.5_0.009_nopromopt%a.out
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/search_rankllama_mlm_decoder_only_opt3.5_0.009_nopromopt%a.out
#SBATCH --array=1
#SBATCH --partition=cpu

export HYDRA_FULL_ERROR=1
MODLE_NAME=rankllama_mlm_decoder_only_opt3.5_0.009_nopromopt
