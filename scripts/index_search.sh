#!/bin/bash
#SBATCH --job-name=search_mlp_encoder_only_t5_base
#SBATCH --mem=30G
#SBATCH --time=8:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/search_mlp_encoder_only_t5_base%a.out
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/search_mlp_encoder_only_t5_base%a.out
#SBATCH --array=1
#SBATCH --partition=cpu

export HYDRA_FULL_ERROR=1
MODLE_NAME=mlp_encoder_only_t5_base
