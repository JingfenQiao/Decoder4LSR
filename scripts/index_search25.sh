#!/bin/bash
#SBATCH --job-name=search_rankllama_mlm_decoder_only_opt3.5_0.009
#SBATCH --mem=30G
#SBATCH --time=50:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/search_rankllama_mlm_decoder_only_opt3.5_0.009%a.out
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/search_rankllama_mlm_decoder_only_opt3.5_0.009%a.out
#SBATCH --array=1
