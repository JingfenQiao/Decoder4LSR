#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=t5_base_dl19
#SBATCH --mem=30G
#SBATCH --time=10:00:00
#SBATCH --output=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/t5_base_dl19.output
#SBATCH --error=/ivi/ilps/personal/tnguyen5/jf/lsr_eval/log/t5_base_dl19.output
