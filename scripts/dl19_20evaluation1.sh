#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=search_dl19_20_qmlp_dmlm_encoder_decoder_multi_t5_base_0.0_0.08.output
#SBATCH --mem=30G
#SBATCH --time=10:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/lsr_eval/log/search_dl19_20_qmlp_dmlm_encoder_decoder_multi_t5_base_0.0_0.08.output
#SBATCH --error=/ivi/ilps/personal/jqiao/lsr_eval/log/search_dl19_20_qmlp_dmlm_encoder_decoder_multi_t5_base_0.0_0.08.output
...
+experiment=qmlm_dmlp_encoder_decoder_multi_t5_base_0.1_0.0
