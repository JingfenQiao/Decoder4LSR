#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=zero_shot_flan_t5_large
#SBATCH --mem=30G
#SBATCH --time=20:00:00
#SBATCH --output=./log/zero_shot_flan_t5_large%a.output
#SBATCH --error=./log/zero_shot_flan_t5_large%a.output
...
experiment=zero_shot_flan_t5_large
...
MODLE_NAME=zero_shot_flan_t5_large
