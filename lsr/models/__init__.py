...
from .mlm_de_multi_llama_lora import TransformerMLMLlamaLoraDecoderMultiStepsConfig, TransformerMLMSparseLlamaLoraDecoderMultiSteps
...
AutoModel.register(TransformerMLMEncoderDecoderMultiStepsMultiStepsConfig, TransformerMLMSparseEncoderDecoderMultiStepsMultiSteps)
...
AutoConfig.register("MLM_LLAMA_LORA_DECODER_MULTISTEPS", TransformerMLMLlamaLoraDecoderMultiStepsConfig)
AutoModel.register(TransformerMLMLlamaLoraDecoderMultiStepsConfig, TransformerMLMSparseLlamaLoraDecoderMultiSteps)