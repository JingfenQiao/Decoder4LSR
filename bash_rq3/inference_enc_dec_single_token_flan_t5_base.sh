#!/bin/bash
#SBATCH -p gpu
#SBATCH --job-name=mlm_encoder_decoder_single_t5_base
#SBATCH --output=./log/mlm_encoder_decoder_single_t5_base.output
#SBATCH --error=./log/mlm_encoder_decoder_single_t5_base.output
#SBATCH --time=120:00:00
#SBATCH --gpus=1

export variable HYDRA_FULL_ERROR=1
# Generate sparse representation for queries
experiment=mlm_encoder_decoder_single_t5_base
...
MODLE_NAME=mlm_encoder_decoder_single_t5_base
